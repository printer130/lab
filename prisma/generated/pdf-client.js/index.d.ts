...
/**
   ...
   * `prisma.pdf`: Exposes CRUD operations for the **pdf** model.
    ...
    * ```
    */
  get pdf(): Prisma.pdfDelegate<GlobalReject>;
}
  ...
  */
  ...
  export type PdfAggregateArgs = {
    ...
    **/
     ...
     * 
    **/
    orderBy?: Enumerable<pdfOrderByWithRelationInput>
    /**
  ...
  export type PdfGroupByArgs = {
    where?: pdfWhereInput
    orderBy?: Enumerable<pdfOrderByWithAggregationInput>
    by: Array<PdfScalarFieldEnum>
  ...
  type GetPdfGroupByPayload<T extends PdfGroupByArgs> = Promise<
    Array<
      PickArray<PdfGroupByOutputType, T['by']> &
        {
  ...
  export type pdfGetPayload<
    S extends boolean | null | undefined | pdfArgs,
    U = keyof S
      > = S extends true
        ? pdf
    : S extends undefined
    ? never
    : S extends pdfArgs | pdfFindManyArgs
    ?'include' extends U
    ? pdf 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof pdf ?pdf [P]
  : 
     never
  } 
    : pdf
  ...
  type pdfCountArgs = Merge<
    Omit<pdfFindManyArgs, 'select' | 'include'> & {
      select?: PdfCountAggregateInputType | true
    }
  >

  export interface pdfDelegate<GlobalRejectSettings> {
    /**
     ...
     * })
    **/
    findUnique<T extends pdfFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, pdfFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'pdf'> extends True ? CheckSelect<T, Prisma__pdfClient<pdf>, Prisma__pdfClient<pdfGetPayload<T>>> : CheckSelect<T, Prisma__pdfClient<pdf | null >, Prisma__pdfClient<pdfGetPayload<T> | null >>
     ...
     * })
    **/
    findFirst<T extends pdfFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, pdfFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'pdf'> extends True ? CheckSelect<T, Prisma__pdfClient<pdf>, Prisma__pdfClient<pdfGetPayload<T>>> : CheckSelect<T, Prisma__pdfClient<pdf | null >, Prisma__pdfClient<pdfGetPayload<T> | null >>
    ...
    **/
    findMany<T extends pdfFindManyArgs>(
      args?: SelectSubset<T, pdfFindManyArgs>
    ): CheckSelect<T, PrismaPromise<Array<pdf>>, PrismaPromise<Array<pdfGetPayload<T>>>>
    ...
    **/
    create<T extends pdfCreateArgs>(
      args: SelectSubset<T, pdfCreateArgs>
    ): CheckSelect<T, Prisma__pdfClient<pdf>, Prisma__pdfClient<pdfGetPayload<T>>>
    ...
    **/
    createMany<T extends pdfCreateManyArgs>(
      args?: SelectSubset<T, pdfCreateManyArgs>
    ...
    **/
    delete<T extends pdfDeleteArgs>(
      args: SelectSubset<T, pdfDeleteArgs>
    ): CheckSelect<T, Prisma__pdfClient<pdf>, Prisma__pdfClient<pdfGetPayload<T>>>
    ...
    **/
    update<T extends pdfUpdateArgs>(
      args: SelectSubset<T, pdfUpdateArgs>
    ): CheckSelect<T, Prisma__pdfClient<pdf>, Prisma__pdfClient<pdfGetPayload<T>>>
    ...
    **/
    deleteMany<T extends pdfDeleteManyArgs>(
      args?: SelectSubset<T, pdfDeleteManyArgs>
    ): PrismaPromise<BatchPayload>
    ...
    **/
    updateMany<T extends pdfUpdateManyArgs>(
      args: SelectSubset<T, pdfUpdateManyArgs>
    ): PrismaPromise<BatchPayload>
    ...
    **/
    upsert<T extends pdfUpsertArgs>(
      args: SelectSubset<T, pdfUpsertArgs>
    ): CheckSelect<T, Prisma__pdfClient<pdf>, Prisma__pdfClient<pdfGetPayload<T>>>

    /**
     * Find zero or more Pdfs that matches the filter.
     * @param {pdfFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const pdf = await prisma.pdf.findRaw({
     *   filter: { age: { $gt: 25 } } 
     * })
    **/
    findRaw(
    ...
    /**
     * Perform aggregation operations on a Pdf.
     * @param {pdfAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const pdf = await prisma.pdf.aggregateRaw({
     *   pipeline: [
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends PdfAggregateArgs>(args: Subset<T, PdfAggregateArgs>): PrismaPromise<GetPdfAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, PdfGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetPdfGroupByPayload<T> : Promise<InputErrors>
  }
   ...
   */
  export class Prisma__pdfClient<T> implements PrismaPromise<T> {
    [prisma]: true;
  ...
  export type pdfFindUniqueArgs = {
     ...
     * 
    **/
    select?: pdfSelect | null
    /**
     * Throw an Error if a pdf can't be found
     * 
    **/
  ...
  export type pdfFindFirstArgs = {
    ...
    **/
     ...
     * 
    **/
    distinct?: Enumerable<PdfScalarFieldEnum>
  }
  ...
  export type pdfCreateManyArgs = {
     ...
     * 
    **/
    data: Enumerable<pdfCreateManyInput>
  }
   ...
   * pdf aggregateRaw
   */
  export type pdfAggregateRawArgs = {
    /**
  ...
  export type pdfWhereInput = {
    AND?: Enumerable<pdfWhereInput>
    OR?: Enumerable<pdfWhereInput>
    NOT?: Enumerable<pdfWhereInput>
    id?: StringFilter | string
    name?: StringFilter | string
    url?: StringFilter | string
    json?: BytesFilter | Buffer
  }
  ...
  export type pdfWhereUniqueInput = {
    id?: string
  }
  ...
  export type pdfScalarWhereWithAggregatesInput = {
    AND?: Enumerable<pdfScalarWhereWithAggregatesInput>
    OR?: Enumerable<pdfScalarWhereWithAggregatesInput>
    NOT?: Enumerable<pdfScalarWhereWithAggregatesInput>
    id?: StringWithAggregatesFilter | string
    name?: StringWithAggregatesFilter | string
    url?: StringWithAggregatesFilter | string
    json?: BytesWithAggregatesFilter | Buffer
  }
  ...
  export type pdfUpdateInput = {
    ...
    json?: BytesFieldUpdateOperationsInput | Buffer
  }
